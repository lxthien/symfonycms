...
class UserFixtures extends AbstractFixture implements ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $encodedPassword = $passwordHasher->hashPassword($janeAdmin, 'kitten');
        ...
        $encodedPassword = $passwordHasher->hashPassword($tomAdmin, 'kitten');
        ...
        $encodedPassword = $passwordHasher->hashPassword($johnUser, 'kitten');
