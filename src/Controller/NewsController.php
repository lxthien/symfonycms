...
use App\Analytics\NewsViewTracker;
...
class NewsController extends AbstractController
{
    ...
    private function getPostImageSize(News $post)
    {
        ...
        $candidates = array(
            $this->get('kernel')->getProjectDir() . '/public/' . $imagePath,
            $imagePath,
        );
     ...
     * @return JSON
     **/
    public function handleCommentFormAction(Request $request, MailerInterface $mailer)
    {
