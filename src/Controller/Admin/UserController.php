...
class UserController extends AbstractController
{
    ...
    {
        $this->denyAccessUnlessCanManageUsers();
     ...
     */
    public function newAction(Request $request, UserPasswordHasherInterface $passwordHasher)
    {
        $this->denyAccessUnlessCanManageUsers();
    ...
    /**
     * @Route("/{id}/edit", requirements={"id": "\d+"}, name="admin_user_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{id}/password", requirements={"id": "\d+"}, name="admin_user_password", methods={"GET", "POST"})
     */
    public function passwordAction(Request $request, $id, UserPasswordHasherInterface $passwordHasher)
    {
        $this->denyAccessUnlessSuperAdminCanManageUsers();
        $user = $this->findUser($id);
    ...
    /**
     * @Route("/{id}/toggle", requirements={"id": "\d+"}, name="admin_user_toggle", methods={"POST"})
     */
    ...
    /**
     * @Route("/{id}/delete", requirements={"id": "\d+"}, name="admin_user_delete", methods={"POST"})
     */
    ...
    private function findUser($id)
    {
        ...
        if (!$user) {
            throw $this->createNotFoundException('User không tồn tại.');
        }

        return $user;
    }

    private function denyAccessUnlessCanManageUsers()
    {
        $this->denyAccessUnlessGranted('CMS_USER_MANAGE');
    }

    private function denyAccessUnlessSuperAdminCanManageUsers()
    {
        $this->denyAccessUnlessCanManageUsers();
